...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="number" id="RentalID" name="RentalID" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(PaymentID, RentalID,Amount,PaymentDate,PaymentMethod ) VALUES (?, ?, ?, ?, ?)");
    $stfmt->bind_param("issss", $PaymentID, $RentalID, $Amount, $PaymentDate, $PaymentMethod );
    // Set parameters and execute
    $PaymentID = $_POST['PaymentID'];
    $RentalID = $_POST['user_id'];
    $Amount = $_POST['license_number'];
    $PaymentDate= $_POST['car_model'];
    $PaymentMethod = $_POST['capacity'];
